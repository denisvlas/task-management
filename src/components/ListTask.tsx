...
export const ListTask:React.FC<Props>=({todo,setTodo,modal,setModal})=>{
  ...
  return (
    <div className='task-list'>
        {statuses.map((status,index)=><Section modal={modal} setModal={setModal}  key={index} status={status} todo={todo} setTodo={setTodo} todos={todos}  inProgress={inProgress}  done={done} />)}
